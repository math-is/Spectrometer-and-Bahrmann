...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.driveBtn.setStyleSheet("background-color: rgb(245, 55, 25);\n"
"color: rgb(0, 0, 0);")
        ...
        self.gridLayout.addWidget(self.plotWidget, 21, 2, 1, 1)
...
"color: rgb(0, 0, 0);")
        ...
        self.gridLayout.addWidget(self.btnExit, 19, 4, 1, 1)
